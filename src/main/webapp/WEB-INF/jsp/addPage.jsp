...
<div class="form-row">
    <div class="form-group col-md-6">
      ...
      <form:input  path="firstName" class="form-control rounded-0" id="inputEmail4" required="true"/></div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">Last Name</label>
      <form:input  class="form-control rounded-0" path="lastName" id="inputPassword4" required="true"/>
    </div></div><div class="form-group">
    <label for="inputAddress">Email</label>
    <form:input path="Email" class="form-control rounded-0" required="true"/></div>
