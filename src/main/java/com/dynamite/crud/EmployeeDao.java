...
public class EmployeeDao {
	...
	public int insertEmployees(Employee employee) {
		...
		return jdbcTemplate.update(INSERT_QUERY, employee.getFirstName(), employee.getLastName(), employee.getEmail(),
	...
	public Employee findAllEmployee(String id) {
		if (id != null) {
			...
			return (Employee) jdbcTemplate.queryForObject(sql, new Object[] {},
					new BeanPropertyRowMapper(Employee.class));
		}
	...
	public int insertUpdate(Employee employee) {
		...
		return jdbcTemplate.update(INSERT_QUERY, employee.getFirstName(), employee.getLastName(), employee.getEmail(),
				employee.getAddress(), employee.getCity(), employee.getState(), employee.getZip(), employee.getId());
	}
